...
builder.Services.AddScoped<IEscuelaSettingsService, EscuelaSettingsService>();
builder.Services.AddScoped<IGenerarCargosRecurrentesService, Tlaoami.Application.Finanzas.GenerarCargosRecurrentesService>();
